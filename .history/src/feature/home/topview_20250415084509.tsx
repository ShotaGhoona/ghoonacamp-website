...
export default function TopviewSection() {
  return (
    <section className="relative w-full h-screen lg:h-[calc(100vh-58px)]">
      <Image
        src="/topview.jpg"
        alt="Topview Image"
        layout="fill"
      ...
      <div className="absolute inset-0 flex flex-col justify-between px-5 md:px-20 py-16 md:py-24">
        {/* 中央ロゴ部分 */}
        ...
        <div className="text-white max-w-2xl mx-0 md:text-left">
          ...
          <p className="text-[12px] md:text-base mb-1">Ghoona Campでは自己実現のための絶対的な手段</p>
          <p className="text-[12px] md:text-base mb-1">頑張りを習慣に、成長を日常にするための環境を提供します。</p>
