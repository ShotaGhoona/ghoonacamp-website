  ...
  return (
    <section className="relative w-full px-5 md:px-20 py-20 overflow-hidden">
      ...
      <div className="relative mt-8 flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="md:relative md:w-1/2 inset-0 md:rounded-2xl overflow-hidden h-[500px] md:h-[600px]">
          <Image 
            src="/philosophy.jpg" 
          ...
          <div className="absolute z-10 md:w-1/2 text-gray-900 flex flex-col gap-4">
            <p>
                早起きは三文の徳<br />
