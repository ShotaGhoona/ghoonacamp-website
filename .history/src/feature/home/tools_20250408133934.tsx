...
export default function ToolsSection() {
  return (
    <section id="tools" className="relative w-full bg-no-repeat bg-cover px-5 md:px-20 py-20">
      <SectionTitle title="How we Communicate" subtitle="コミュニケーションツール" />
      <div className="flex flex-col md:flex-row justify-center items-center">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-4 text-xl md:text-sm xl:text-xl font-bold">
            <p>朝6:00-8:00に集まる</p>
            <p>Discordコミュニティ</p>
          </div>
        </div>
