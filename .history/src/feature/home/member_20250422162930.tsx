...
export default function MemberSection() {
  const members = [
    ...
    },
    {
      ...
      name: '村山大',
      nameEn: 'Dai Murayama',
      description: '2024年、慶應義塾大学総合政策学部入学。インドでのバックパックの最中に、Ghoonaの代表山下と出会う。偶然の出会いの中、朝活のビジョンに腹の底から共感。同じ船に乗り一緒に駆け出すことを決意。朝活サービスGhoona Campの立ち上げ初期から関わる。',
      dream: '高い視座で大きなことを',
    },
    {
      image1Url: '/member/daimurayama1.jpg',
    ...
    },
    {
      ...
      name: '村山大',
      nameEn: 'Dai Murayama',
      description: '2024年、慶應義塾大学総合政策学部入学。インドでのバックパックの最中に、Ghoonaの代表山下と出会う。偶然の出会いの中、朝活のビジョンに腹の底から共感。同じ船に乗り、一緒に駆け出すことを決意。朝活サービスGhoonaCampの立ち上げ初期から関わる。',
      dream: '高い視座で大きなことを',
    },
    {
      image1Url: '/member/daimurayama1.jpg',
  ...
  return (
    <section id="member" className="w-full py-10">
      ...
      <div className="mt-8">
        <div className="flex gap-10 overflow-x-auto hidden-scrollbar py-5 pl-5 md:pl-20">
