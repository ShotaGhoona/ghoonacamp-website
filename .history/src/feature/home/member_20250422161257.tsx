...
export default function MemberSection() {
  ...
  return (
    <section id="member" className="w-full py-10">
      ...
      <div className="mt-8 relative px-5 md:px-20">
        <div className="flex gap-10 overflow-x-auto scroll-smooth snap-x snap-mandatory py-5 -mx-5 md:-mx-20 px-5 md:px-20">
        ...
        <div className="absolute inset-y-0 left-0 w-5 md:w-20 bg-gradient-to-r from-white to-transparent pointer-events-none" />
        <div className="absolute inset-y-0 right-0 w-5 md:w-20 bg-gradient-to-l from-white to-transparent pointer-events-none" />
      </div>
    </section>
  );
}
