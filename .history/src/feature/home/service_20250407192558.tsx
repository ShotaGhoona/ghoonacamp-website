    ...
    return (
      <section className="relative w-full bg-no-repeat bg-cover px-5 md:px-20 py-20">
        ...
        <div className="text-center py-10">
          <p className="text-2xl font-bold">2025年、全国のわかものの朝を盛り上げるために作られた</p>
          <p className="text-2xl font-bold">若者の若者による若者のための</p>
          <p className="text-2xl font-bold">オンラインコミュニティ</p>
        </div>
