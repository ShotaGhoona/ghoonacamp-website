    ...
    return (
      <section id="about" className="relative w-full bg-no-repeat bg-cover px-5 md:px-20 py-20">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
            ...
            <ServiceCard
            title="刺激し合う仲間"
            description="毎日顔を合わせるうちに自然と仲良くなった仲間たちと、励まし合ったり、ちょっとした進捗を称え合ったり。そんな温かいやり取りが日常的にあるのが、このコミュニティの魅力です。それぞれが夢や目標に本気で向き合っているからこそ、自分も「よし、今日もがんばろう」って思える。同じ気持ちを共有できる仲間がいる時間は、毎日の原動力になります。"
            imageUrl="team.png"
            href="/service/camp"
            />
        </div>
