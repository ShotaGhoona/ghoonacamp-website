  ...
  return (
    <div className="w-full md:w-[300px] relative bg-white rounded-xl shadow-xl p-4 md:p-8 flex flex-col items-center text-center">
      ...
      <div className="flex flex-row md:flex-col items-center justify-center w-full">
        <div className="w-[30%] flex items-center justify-center my-4">
          {imageUrl ? (
            <img src={imageUrl} alt={title} className="object-contain w-full h-auto" />
          ) : (
            <span className="text-gray-400">No Image</span>
          )}
        </div>
        <div className="w-[70%] text-left md:text-center">
