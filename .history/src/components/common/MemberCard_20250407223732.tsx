    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-white/90 via-white/60 to-transparent flex flex-col justify-end px-4 py-5">
        <div className="flex gap-2 items-baseline">
          <h2 className="text-[12px] md:text-xl font-bold">{name}</h2>
          <h3 className="text-[8px] md:text-sm">{nameEn}</h3>
        </div>
        <p className="text-[12px] md:text-medium font-bold text-gray-800 my-2 overflow-hidden">「{dream}」</p>
        <p className="text-[10px] md:text-sm text-gray-800 mb-2 overflow-hidden line-clamp-5">{description}</p>
      </div>
    </div>
  );
}