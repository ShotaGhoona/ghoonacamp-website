...
export default function LINEInvite({ href, text = "LINE公式アカウントはこちら" }: LINEInviteProps) {
  return (
    <Link href={href} className="inline-flex items-center bg-[#d5697e] text-white font-bold py-3 px-10 rounded-full shadow-lg hover:opacity-80 transition-opacity">
