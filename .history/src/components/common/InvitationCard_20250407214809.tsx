...
export default function InvitationCard({ number, imageUrl, subtitle, title }: InvitationCardProps) {
  return (
    <div className="w-[300px] relative bg-white rounded-xl shadow-xl p-8 flex flex-col items-center text-center">
      ...
      <p className="text-xl md:text-2xl font-bold text-gray-900">{title}</p>
    </div>
  );
}